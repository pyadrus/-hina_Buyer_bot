...
def load_bot_info_services_and_prices():
    with open("messages/types_packaging_messages/wooden_sheathing_bag_tape_messages.json", 'r', encoding='utf-8') as json_file:
...
def wooden_sheathing_bag_tape_handlers_register_message_handler():
    ...
    dp.message.register(wooden_sheathing_bag_tape_handlers)
